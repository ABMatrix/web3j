...
public class MatrixGetBlockByHash extends Response<MatrixGetBlockByHash> {
    ...
    private int version;
    private String hash;
    private MatrixGetBlockByNumber.HeaderBean header;
    private MatrixGetBlockByNumber.BodyBean body;
    ...
    public MatrixGetBlockByNumber.HeaderBean getHeader() {
        return header;
    }

    public void setHeader(MatrixGetBlockByNumber.HeaderBean header) {
        this.header = header;
    }

    public MatrixGetBlockByNumber.BodyBean getBody() {
        return body;
    }

    public void setBody(MatrixGetBlockByNumber.BodyBean body) {
        this.body = body;
    }
    ...
    public class HeaderBean {
        ...
        private MatrixGetBlockByNumber.HeaderBean.ProofBean proof;
        ...
        public MatrixGetBlockByNumber.HeaderBean.ProofBean getProof() {
            return proof;
        }

        public void setProof(MatrixGetBlockByNumber.HeaderBean.ProofBean proof) {
            this.proof = proof;
        }
        ...
        public class ProofBean {
            ...
            private MatrixGetBlockByNumber.HeaderBean.ProofBean.BftBean Bft;

            public MatrixGetBlockByNumber.HeaderBean.ProofBean.BftBean getBft() {
                return Bft;
            }

            public void setBft(MatrixGetBlockByNumber.HeaderBean.ProofBean.BftBean Bft) {
                this.Bft = Bft;
            }
